...
var (
	...
	DialDNSLatency     = NewTimerDef("dial_dns_latency", WithDescription("Latency of DNS lookup."))
	...
	DialTLSLatency     = NewTimerDef("dial_tls_latency", WithDescription("Latency of TLS handshake."))
